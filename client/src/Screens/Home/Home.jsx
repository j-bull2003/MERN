...
const Home = (props) => {
    ...
    // Set initial state for geolocation and weather data
    ...
    // Call getLocation function when component mounts
    useEffect(() => {
        getLocation()
    }, [])
